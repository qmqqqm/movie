...
<script src="https://cdnjs.cloudflare.com/ajax/libs/jquery/3.2.1/jquery.min.js" type="text/javascript"></script>
 ...
 <style type="text/css">
 	...
 	#reviewForm{ width: 100%; clear: both;}
 </style>
</head>
<body>
	<c:if test="${memberDto==null}">
		<c:import url="/WEB-INF/views/member/loginForm.jsp">
		</c:import>
	</c:if>
	<c:if test="${memberDto!=null}">
		<div id="reviewForm">
			<form name="pkc" action="${contextPath}/movie/reviewWrite.do">
				<input type="hidden" id="member_id" name="member_id" value="${memberDto.member_id }" />
				<label for="member_name">작성자 :</label>
				 <input type="text" id="member_name" name="member_name"  value="${memberDto.member_name }" readonly><p>
				 <label for="movie_id">영화번호 : </label>
				<input type="text" id="movie_id" name="movie_id" value="${movie_id}" readonly><p>
				...
				리뷰내용 : <textarea id="review_review" name="review_review"  style="width:200px;height:100px"  required></textarea><p>
