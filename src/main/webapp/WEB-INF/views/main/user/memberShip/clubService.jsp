...
<!-- LineMap -->
            ...
            <div class="sect-linemap">
                <div class="sect-bcrumb">
                    <ul>
                        <li><a href="main.do"><img alt="home" src="/movie/resources/images/common/btn/btn_home.png" /></a></li>
                            ...
                            <li >
                                <a href="../../theaters/index.html">극장</a>
                            </li>
                ...
                <div class="sect-special">
                    <ul>                      
                        ...
                        <li><a href="ClubService.html" title="새창" class="specialclub">Club서비스</a></li>
    ...
    <div id="contents">
      <form name="aspnetForm" method="post" action="http://www.cgv.co.kr/user/memberShip/ClubService.aspx" id="aspnetForm">
<div>
...
<div>
    ...
    <div class="club-listbox cl-box1">
        <div class="thumb-box">
            <a href="#cb1-2">
                <img src="/movie/resources/images/club/img_club_thumb4_2020.jpg" alt="">
                <span class="desc-dim" style="display: none;">
                    <img src="/movie/resources/images/club/img_club_thumb4_over.png" alt="1318클럽 - 만 13세에서 18세까지의 중ㆍ고등학교 청소년 회원을 위한 무료 클럽 서비스로 영화/ 매점 할인 및 포인트 혜택 등 1318 클럽 회원만을 위한 특별한 혜택이 제공됩니다.">
                </span>
            </a>
        </div>
        ...
        <div class="benefitbox">
            ...
            <div class="desc_1318">
                ...
                <div class="qr_img_area">
                    <img src="/movie/resources/images/club/qr_1318.png" alt="1318 QR CODE">
                </div>
            </div>
            <!-- 1318 가입 혜택 -->
...
<div class="club-listbox cl-box2">
	<div class="thumb-box">
		<a href="#couplingClub">
			<img src="/movie/resources/images/club/img_club_thumb9.jpg" alt="" />
			<span class="desc-dim">
				<img src="/movie/resources/images/club/img_club_thumb9_over.png" alt="COUPLING CLUB - 현재 진행형(ing)인 커플(Couple)이라면 누구나 누릴 수 있는 CGV 커플 전용 클럽 서비스입니다." />
			</span>
		</a>
	</div>
        ...
        <div class="benefit-tabbox coupling_club">
            <div class="btab-cont" id="btabCont8">
                <div class="artist_intro2">
                    ...
                    <img class="qrcode" src="/movie/resources/images/club/img_qrcode_coupling.png" alt="QR CODE">
                </div>
                <div class="dv_line">
...
<div class="club-listbox cl-box1">
	<div class="thumb-box">
		<a href="#cb2-2">
			<img src="/movie/resources/images/club/img_club_thumb5_re.png" alt="" />
			<span class="desc-dim">
				<img src="/movie/resources/images/club/img_club_thumb5_over.png" alt="CGV 키즈패밀리클럽 -  온 가족이 떠나는 무비트립. 초등학생(만 12세)이하 자녀를 둔 부모라면 누구나 가입 가능한 무료 클럽서비스로 영화, 매점 할인 등 회원 전용 특별한 혜택이 제공됩니다." />
			</span>
		</a>
	</div>
	<div class="club-titbox">
		<strong class="club-tit">키즈 패밀리 Club</strong>
		<div id="joinBtnKizclubExp" style="display:none">
    ...
    <!-- 키즈패일리 클럽 상세 상단 -->
		<div class="benefitbox-spot type2">
			<div class="kids-movie">
				...
				<div class="slider" id="kidsMovieSlider">
                        ...
                        <div class="item-wrap">
							<div class="item">
								<a href="../../movies/detail-view/index5ba5.html?midx=84477">
									<span class="km-poster">
										<span class="thumb-image">
											<img src="../../../img.cgv.co.kr/Movie/Thumbnail/Poster/000084/84477/84477_320.jpg" alt="국카스텐 콘서트 실황 : 해프닝" onerror="errorImage(this)">
										</span>
                                                            
										&nbsp;<span class="movie-infocon"><strong class="km-movietit">국카스텐 콘서트 실황 : 해프닝</strong><span class="score"><strong class="percent">예매율<span>1.08%</span></strong>
                        ...
                        <div class="item-wrap">
							<div class="item">
								<a href="../../movies/detail-view/index1553.html?midx=83946">
									<span class="km-poster">
										<span class="thumb-image">
											<img src="../../../img.cgv.co.kr/Movie/Thumbnail/Poster/000083/83946/83946_320.jpg" alt="라야와 마지막 드래곤" onerror="errorImage(this)">
										</span>
                                                            
										&nbsp;<span class="movie-infocon"><strong class="km-movietit">라야와 마지막 드래곤</strong><span class="score"><strong class="percent">예매율<span>0.61%</span></strong>
												<span class="egg-gage small">
													<span class="egg great"></span>
													<span class="percent">97%</span>
												</span>
                        ...
                        <div class="item-wrap">
							<div class="item">
								<a href="../../movies/detail-view/index2920.html?midx=84380">
									<span class="km-poster">
										<span class="thumb-image">
											<img src="../../../img.cgv.co.kr/Movie/Thumbnail/Poster/000084/84380/84380_320.jpg" alt="고질라 VS. 콩" onerror="errorImage(this)">
										</span>
                                                            
										&nbsp;<span class="movie-infocon"><strong class="km-movietit">고질라 VS. 콩</strong><span class="score"><strong class="percent">예매율<span>24.76%</span></strong>
												<span class="egg-gage small">
													<span class="egg great"></span>
                        ...
                        <div class="item-wrap">
							<div class="item">
								<a href="../../movies/detail-view/indexe2ba.html?midx=84184">
									<span class="km-poster">
										<span class="thumb-image">
											<img src="../../../img.cgv.co.kr/Movie/Thumbnail/Poster/000084/84184/84184_320.jpg" alt="자산어보" onerror="errorImage(this)">
										</span>
                                                            
										&nbsp;<span class="movie-infocon"><strong class="km-movietit">자산어보</strong><span class="score"><strong class="percent">예매율<span>18.1%</span></strong>
												<span class="egg-gage small">
													<span class="egg great"></span>
                        ...
                        <div class="item-wrap">
							<div class="item">
								<a href="../../movies/detail-view/indexf613.html?midx=84499">
									<span class="km-poster">
										<span class="thumb-image">
											<img src="../../../img.cgv.co.kr/Movie/Thumbnail/Poster/000084/84499/84499_320.jpg" alt="[LoL e스포츠]2021 LCK 스프링 결승(ScreenX)" onerror="errorImage(this)">
										</span>
                                                            
										&nbsp;<span class="movie-infocon"><strong class="km-movietit">[LoL e스포츠]2021 LCK 스프링 결승(ScreenX)</strong><span class="score"><strong class="percent">예매율<span>0.21%</span></strong>
												<span class="egg-gage small">
                        ...
                        <div class="item-wrap">
							<div class="item">
								<a href="../../movies/detail-view/index2573.html?midx=84338">
									<span class="km-poster">
										<span class="thumb-image">
											<img src="../../../img.cgv.co.kr/Movie/Thumbnail/Poster/000084/84338/84338_320.jpg" alt="[사이다경제_사계강의(봄)]지금 당장 시작하는 주식 공부 5일 완성" onerror="errorImage(this)">
										</span>
                                                            
										&nbsp;<span class="movie-infocon"><strong class="km-movietit">[사이다경제_사계강의(봄)]지금 당장 시작하는 주식 공부 5일 완성</strong><span class="score"><strong class="percent">예매율<span>0.12%</span></strong>
												<span class="egg-gage small">
													<span class="egg good"></span>
													<span class="percent">?</span>
												</span>
		...
		<div class="benefit-tabbox">
            ...
            <div class="btn_with_group">
                <button type="button" class="round gray btn_withdraw" id="btn_kizUpdate"><span>자녀정보 수정</span></button>
                <button type="button" class="round gray btn_withdraw" id="btn_kizWithdraw"><span>서비스해지</span></button>
            </div>
		</div>
		<button type="button" class="btn-close">닫기</button>
	</div>
	...
	<div class="layer-contents" style="width:522px;">
		<div class="popwrap">
			...
			<div class="pop-contents">
				<div class="pop-hd-msg">
					<p>
						<strong class="em-txt">&lsquo;키즈패밀리Club&rsquo;탈퇴를 신청하기 전에<br />다음 사항을 꼭 확인하여 주시기 바랍니다.</strong>
					</p>
				</div>
...
<!--// 키즈 패밀리 Club 서비스탈퇴 pop -->
 ...
 <!-- 4. 치어스 Club 화면 기능 로직처리되는 부분 USERCONTROL을 통해 출력 -->
		...
		<div class="club-listbox cl-box2">
			<div class="thumb-box">
				<a href="#cb3-2">
					<img src="/movie/resources/images/club/img_club_thumb_cheers.jpg" alt="" />
					<span class="desc-dim">
						<img src="/movie/resources/images/club/img_club_thumb_cheers_over.png" alt="치어스 클럽 무비 & 컬처 라이프를 즐기는 50세 이상 회원님만을 위한 무료 멤버십 서비스 입니다." />
					</span>
				</a>
			</div>
			<div class="club-titbox">
		...
		<div class="club-benefit cb-r" id="cb3-2">
			<div class="benefitbox cheers_club">
				...
				<div class="desc_club">
					...
					<!-- 치어스 클럽 QR 코드 -->
					<div class="qr_img_area">
						<img src="/movie/resources/images/club/qr_cheers.png" alt="치어스 Club QR CODE"/>
					</div>
				</div>   				
                <div class="benefit-tabbox cheers_club">
					...
					<div class="dv_line" id="li_ment_n">
						<div class="tit_evt_list">
	    ...
	    <div class="layer-contents" style="width:522px;">
		    <div class="popwrap">
			    ...
			    <div class="pop-contents">
				    <div class="pop-hd-msg">
					    <p>
						    <strong class="em-txt">&lsquo;노블레스Club&rsquo;탈퇴를 신청하기 전에<br />다음 사항을 꼭 확인하여 주시기 바랍니다.</strong>
					    </p>
				    </div>
	...
	<div class="club-listbox cl-box1">
		<div class="thumb-box" id ="boxGrade">
			<a href="#cb1-1" id="yok">
				<img src="/movie/resources/images/club/img_club_thumb1_2020.jpg" alt="2021아트하우스 클럽" />
				<span class="desc-dim">
					<img src="/movie/resources/images/club/img_club_thumb1_over.png" alt="CGV 아트하우스 Club - CGV아트하우스의 특별한 혜택을 누릴 수 있는 회원제 서비스로, 아트하우스 영화를 즐겨보고 좋아하는 사람이라면 누구나 가입할 수 있습니다." />
				</span>
			</a>
		</div>
		<div class="club-titbox">
			...
			<div id="btn_ArtRegister" style="display:none">
	...
	<div class="club-benefit cb-l" id="cb1-1" >
		<div class="benefitbox">
			...
			<div class="grade-infobox user_grade" id="usergrade" >
				<div class="inner">
					<strong class="gi-tit">아트하우스 Club 가입을 축하드립니다.</strong>
					<p class="gi-txt">가입 익일 고객님의 등급이 공개되오니<br />잠시만 기다려주세요!</p>
				</div>
			</div>
            ...
            <div class="benefit-tabbox" style="height:2700px">
						...
						<div class="btab-cont" id="Div1">
                            ...
                            <div class="mission357-event">
								<div class="mission_txt_area">
									...
									<p class="me-txt">
										...
										* 미션 관람 횟수는 2021년 1/1부터 시작되며 미션 완료 시 1회부터 다시 참여가능(최대 5회)<br />                                        
									</p>
									<a class="link-txt" href="javascript:joinArtMovieOpen();">2021년 내가 본 아트하우스 영화 : <span id="OpenCnt"></span>편 &gt;</a>
								</div>
                                ...
                                <div class="mission-stat type4">
									...
									<div class="coupon-down cd1" id="FourClass">
										<ul class="cd-tit">
                                                ...
                                                <li class="">
                                                    <em>(공통혜택)</em><br>아트하우스관 주중무료쿠폰 1매 : <span class="cnt"><span id="FourCntC"></span>회</span>
                                                </li>
                                                <li class=""><em>(아티스트 전용 혜택)</em><br>이동진의 라이브톡 중계관 1천원 할인쿠폰 1매 <span class="cnt"><span id="FourCntA"></span>회</span></li>
                                                <li class="">아메리카노 50% 할인쿠폰 1매 <span class="cnt"><span id="FourCntA1"></span>회</span></li>
										</ul>
									...
									<div class="coupon-down cd2" id="EightClass">
										<ul class="cd-tit">
                                                <li class="">
                                                    <em>(공통혜택)</em><br>아트하우스관 무료쿠폰 1매 : <span class="cnt"><span id="EightCntC"></span>회</span>
                                                </li>
                                                <li class=""><em>(아티스트 전용 혜택)</em><br>아트하우스관 주중무료쿠폰 1매 <span class="cnt"><span id="EightCntA"></span>회</span></li>
                                                <li class="">CGV/더블/라지 콤보 5천원 할인쿠폰 1매 <span class="cnt"><span id="EightCntA1"></span>회</span></li>                                        
										</ul>
							...
							<ul class="benefit-list arthouse1">                                
								<li class="bl1">
									...
									<ul>
                                        <li>아트하우스관 상영작 ‘둘이서 만원’ 쿠폰 2매</li>
                                        <li>에스프레소 음료 30% 할인쿠폰 2매<br />
                                        * 지점별 에스프레소 음료는 상이할 수 있음(에스프레소 음료: 아메리카노,카페라떼,카푸치노,카라멜마끼아또,카페모카 등)
                                        </li>
                                        <li>매점 스몰세트(팝콘M1+탄산음료M1) 1천원 할인쿠폰 2매<br />
                                        * 대구현대, 명동 대체 운영(대구, 명동역 씨네라이브러리 운영재개시 적용 극장 변동예정)</li>
									</ul>
								</li>		
								<li class="bl2">
								  <strong class="bl-tit">포인트 혜택</strong>
									<ul>
										...
										<li>명동, 지방거점극장 포인트 더블 적립 [매주 월요일]<br /> 
                                            *지방거점사이트 : 광주터미널, 대구현대, 대전, 서면, 천안, 청주(서문), 춘천<br />
                                            * 대구현대, 명동 대체 운영(대구, 명동역 씨네라이브러리 운영재개시 적용 극장 변동예정)</li>
									</ul>
								</li>
                            	<li class="bl3">
									<strong class="bl-tit">이벤트</strong>
								    <ul>
                                        <li>한정판 영화 굿즈 증정(선착순/야광엽서 2종 랜덤증정)</li>
										<li>회원 전용 시사회, 이벤트</li>
										<li>(뉴스레터) 기획전 할인쿠폰<br />* 마케팅 수신동의 고객에 한함</li>
									</ul>
								</li>				
							...
							<div class="benefit-sinfo">								
                                <ul class="benefit-slist type2">
                                    <li>
										...
										<ul>
                                            <li>아트하우스 Club 혜택은 상반기 2021년 6월 28일, 하반기 2021년 12월 29일 내 가입자에 한하여 각각 2021년 6월 30일, 2021년 12월 31일까지 제공됩니다. 단, 운영 서비스 및 혜택은 변경/종료될 수 있습니다.</li>
                                            <li>아트하우스 Club 혜택은 CJ ONE 포인트 적립 시 혜택을 받으실 수 있습니다.</li>
                                            <li>아트하우스 영화는 아트하우스 전용관에서 상영하는 유료 관람 영화(CJ ONE 포인트 적립 티켓 限)에 한합니다.</li>
                                    ...
                                    <li>                                   
										...
										<ul>
                                            ...
                                            <li>쿠폰별 사용기간이 상이하므로 반드시 확인 후 사용하시기 바랍니다.</li>
                                            <li>모든 쿠폰은 타 쿠폰과 중복 사용이 불가하며 청소년/우대/어린이 권종 시 사용이 불가합니다. 단 아트하우스 전용관에서 상영하는 일반영화에만 사용 가능합니다.(조조, 심야,이코노미 등 일부 제외, 기획전, 상영회, 톡 프로그램, 기타 특별프로그램, 특별 할인영화(예: 무비핫딜, 컬쳐데이 등) 사용 불가)</li>
                                            <li>아트하우스관 상영작 ‘둘이서 만원’ 쿠폰은 동일극장, 동일영화, 동일회차에만 적용되고 온라인에서만  사용 가능합니다.(홈페이지/모바일) </li>
                                            <li>아메리카노, 에스프레소음료, 스몰세트 할인쿠폰은 CJ ONE 카드(모바일 포함) 지참 시 아래 지점에서만 사용 가능합니다.</li>
                                            <li>매점 : CGV광주터미널, 구로, 대구, 대전, 서면, 압구정, 오리, 용산아이파크몰, 인천, 평촌</li>
                                            <li>투썸플레이스 : CGV강변, 명동역 씨네라이브러리, 소풍, 여의도, 천안, 춘천</li>
                                            <li>씨네카페 : CGV청주(서문) </li>
                                            <li>앤티앤스 : CGV신촌아트레온</li>
                                            <li>스몰세트 할인쿠폰  : CGV강변, 광주터미널, 구로, 대구, 대전, 명동역 씨네라이브러리, 서면, 소풍, 신촌아트레온,  압구정, 여의도, 오리, 용산아이파크몰, 인천, 천안, 청주(서문), 춘천, 평촌</li>											
										</ul>													
									</li>
									<li>
                                    ...
                                    <li>
										...
										<ul>
                                            <li>관람횟수는 2021년 1월 1일부터 아트하우스 전용관’에서 ‘유료 관람(CJ ONE 포인트 적립 티켓 限)’인 경우에만 인정됩니다.(관람권, 기프티콘 등 CJ ONE 포인트 적립이 되지 않는 내역은 스탬프 날인 불가)</li>
										...
										<ul>
                                            <li>미션달성 쿠폰은 2021년 12월 30일까지의 관람 내역에 한하여 2021년 12월 31일까지 다운로드 가능하며, 쿠폰을 다운로드 받은 날부터 60일 이내에만 사용가능합니다.</li>
                                            <li>모든 쿠폰은 타 쿠폰과 중복 사용이 불가하며 우대/어린이 권종 시 사용이 불가합니다. 단 아트하우스 전용관에서 상영하는 일반영화에만 사용 가능합니다. (조조, 나이트, 이코노미 등 일부 제외, 기획전/상영회/톡 프로그램/기타 특별프로그램/특별 할인영화(예: 무비핫딜, 컬처데이 등) 사용 불가)</li>
                                            <li>온라인 전용(CGV홈페이지, 모바일 예매 가능)<br><br></li>
										</ul>
										<em class="bl-tit3">&lt;매점 쿠폰&gt;</em>
										<ul>
											<li>CGV/더블/라지 콤보 5천원 할인쿠폰 : 강변, 광주터미널, 구로, 대구, 대전, 명동역 씨네라이브러리, 서면, 소풍, 신촌아트레온, 압구정, 여의도, 오리, 용산아이파크몰, 인천, 천안, 청주(서문), 춘천, 평촌</li>																																				
										</ul>                                        
                                    </li>								                                    
								</ul>	
					...
					<li><a class="btab-tit" href="#">아티스트 추가 혜택</a>
						<div class="btab-cont" id="Div2">
							<div class="artist_intro">
								<div class="ai-tit">&lsquo;아티스트란&rsquo;? 아트하우스 영화를 진정 사랑하는 아트하우스 Club 회원님을 위한 스페셜 등급</div>
									<ul>
									<li>조건<br>- 2021년 상반기(1월~6월) : 아트하우스 Club 회원 중 2020년 하반기 아트하우스 전용관에서 4회 이상 관람한 회원<br>- 2021년 하반기(7월~12월) : 아트하우스 Club 회원 중 2021년 상반기 아트하우스 전용관에서 4회 이상 관람한 회원 </li>
                                    <li>서로 다른 영화, 유료 관람 기준(CJ ONE 포인트 적립)</li>
									<li>신규 가입 회원의 경우 2021년 관람조건 충족 시 가입 2일 후 자동 등급 부여</li>
								</ul>
							</div>
						 	...
						 	<ul class="benefit-list">
							   <li class="bl1">
								...
								<li class="bl3">
									...
									<ul>
                                        <li>투썸 아메리카노 무료 사이즈업</li>
                                        <li>한정판 영화 굿즈 증정(선착순/렌티큘러 포스터(A3) 증정) </li>                                        
									</ul>
								</li>
								<li class="bl2">
									<strong class="bl-tit">포인트 혜택</strong>
                               ...
                               <ul class="benefit-slist type2">
									<li>
										...
										<ul>
                                            ...
                                            <li>쿠폰별 사용기간이 상이하므로 반드시 확인 후 사용하시기 바랍니다.</li>
                                            <li>모든 쿠폰은 타 쿠폰과 중복 사용이 불가하며 우대/어린이 권종 시 사용이 불가합니다.<br>또한 아트하우스 전용관에서 상영하는 일반영화에만 사용 가능합니다. (조조, 나이트, 이코노미 등 일부 제외, 기획전/상영회/톡 프로그램/기타 특별프로그램/ 특별 할인영화(예: 무비핫딜, 컬쳐데이 등) 사용 불가)</li>											
										</ul>
                                        <br>
										<em class="bl-tit3">&lt;투썸 아메리카노 무료 사이즈업&gt;</em>										
										<ul>
                                            <li>일 1회 동반 1인까지 연내 무제한 이용 가능합니다.</li>
                                            <li style="color:#FF0000";>아메리카노 50% 할인쿠폰 등 타 쿠폰과 중복사용이 불가합니다.</li>
                                            <li>투썸 아메리카노 무료 사이즈업 사용 가능 극장 :  CGV강변, 명동역 씨네라이브러리, 소풍,<br>여의도, 오리, 인천, 천안, 춘천  매장에서 가능합니다.</li>
										</ul>																		
									</li>
				...
				<button type="button" class="btn_join" id="btn_ArtRegisterSub" style="display:none" onclick="joinArtOpen()" ><span>가입하기</span></button>
		...
		<div class="layer-contents" style="width:522px;">
			<div class="popwrap">
				...
				<div class="pop-contents">
					<div class="pop-hd-msg">
						<p>
							<strong class="em-txt">&lsquo;아트하우스Club&rsquo;탈퇴를 신청하기 전에<br />다음 사항을 꼭 확인하여 주시기 바랍니다.</strong>
						</p>
					</div>
			...
			<div class="popwrap">
				...
				<div class="pop-contents">
					<div class="pop-hd-tit">
						<p>
							<span>2021년 내가 본 아트하우스 영화</span>
							<strong class="em-txt">총 <span id="TotalCnt2"></span>편</strong>
					...
					<div class="movies-list">
						<ul id="artMovieList">
                            <!--
							<li>
								<span class="thumb"><a href="#"><img src="http://img.cgv.co.kr/Movie/Thumbnail/Poster/000080/80489/80489_126.jpg" alt="블랙 팬서 포스터" onerror="errorImage(this)"></a></span>
								<div class="txtbox">
									<span class="tit"><a href="#">코코(더빙)</a></span>
									<ul class="info">
										<li>2018.01.23(화) 16:55</li>
										<li>CGV용산아이파크몰 2관· 2명 관람</li>
									</ul>
								</div>
							</li>
                            -->
	...
	<div class="club-listbox cl-box2">
		<div class="thumb-box">
			<a href="#cb2-1">
				<img src="/movie/resources/images/club/img_club_thumb6.jpg" alt="" />
				<span class="desc-dim">
					<img src="/movie/resources/images/club/img_club_thumb6_over.png" alt="1년 내내 4DX 혜택을 자유롭게 누릴 수 있는 멤버십 카드입니다." />
				</span>
			</a>
		</div>
		<div class="club-titbox">
        ...
        <div class="benefitbox">
			...
			<div class="benefitbox-spot movie-board" id='redCardMovieList'>
				<div class="mb-box">
					...
					<ul class="mb-list" id="redCardNow"></ul>
				</div>
				<div class="mb-box">
					<strong class="mb-tit">COMING SOON</strong>
					<ul class="mb-list" id="redCardComming"></ul>
				</div>
			</div>
					...
					<li class="on"><a class="btab-tit" href="#">혜택</a>
						<div class="btab-cont" id="Div26">
							...
							<div class="redcard-4dx-con">
								<div class="cardimg">
									<img src="/movie/resources/images/club/img_benefit_redcard_4dx.jpg" alt="" />
								...
								<div class="txtgroup">
									...
									<a href="#pop_theater_list1" class="link-txt btn_view_theater_list" id="redcardPopup">판매극장 보기 &gt;</a>
                                    <a href="#" class="link-txt btn_view_theater_list" id="redCardRegister" >카드 조회하기 &gt;</a> 
								</div>
					...
					<li><a class="btab-tit" href="#">프리미엄 혜택</a>
						<div class="btab-cont" id="Div29">
							...
							<div class="redcard-4dx-con">
								...
								<div class="mission357-event">
									<div class="me-tit" id="4DX_CNT_TITLE">내가 본 4DX영화 <em id="4DX_CNT">총 N편</em></div>
									<p class="me-txt" id="4DX_CNT_TXT"></p>
									...
									<div class="mission-stat">
										...
										<div class="coupon-down cd3 able" id="redCardBenefit3">
