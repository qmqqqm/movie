...
public class LostItemListDTO {
	//field
			...
			private List<LostItemDTO> content;//user가 보고싶은 페이지에 속한 특정범위의 게시물조회결과 
			 ...
			 */
			public LostItemListDTO(int total, int currentPage, int size, List<LostItemDTO> content) {
			...
			public List<LostItemDTO> getContent() {
				return content;
			}
